...
SCRIPT = "./codes/estimateW_estim.R"
...
OUTPUT_FILE = "GRANULAR_estim.RData" # as produced by a job on the execute-host, will be remapped with EXPERIMENT and cluster/job numbers to avoid name collisions when transferring back to the submit machine.
